    ...
    def handle_connection(self, conn):
        try:
            ...
            if command_params.command in ACCOUNTED_COMMANDS:
                ...
                print(f"accountinfo: {accounting_info.aggregation_name}, {accounting_info.resource_name}, {accounting_info.lexis_project}, {accounting_info.decode_user_jwt_email()}", file=sys.stderr)
