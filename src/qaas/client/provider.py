...
class QProvider:
    ...
    def __init__(
        self, lexis_project: str, token: str | None = None, provider_access_token=None
    ):
    ...
    def list_available_backends(
        cls, token: str, lexis_project: str, provider_access_token=None
    ) -> list[QBackendMetadata]:
    ...
    def get_backend_info(
        self, lexis_resource: str, quantum_computer_name: str
    ) -> QBackendMetadata:
    ...
    def get_backend(
        ...
        *,
        ...
        client = QClient(
            self._token, self._lexis_project, lexis_resource_name, self._provider_token
        )
...
class QProviderDev(QProvider):
    ...
    def __init__(
        self, lexis_project, token: str | None = None, provider_access_token=None
    ):
